...
if __name__ == "__main__":
    ...
    pipeline = MultimodalRAGPipelineSummaries(model_type=MODEL_TYPE, store_path=VECTORSTORE_PATH_TEXT_ONLY, embedding_model=EMBEDDING_MODEL_TYPE, user_images_dir=USER_IMAGES_DIR)
