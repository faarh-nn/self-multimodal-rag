...
class MultimodalRAGPipelineSummaries:
    ...
    def __init__(self, model_type, store_path, embedding_model, user_images_dir=None):
        ...
        self.rag_chain = MultimodalRAGChain(model=self.model, retriever=self.store_and_retriever.retriever)
    ...
    def answer_question(self, question: str, image_filename: Optional[str] = None) -> str:
        ...
        return self.rag_chain.run(enhanced_query)

def main():
    pipeline = MultimodalRAGPipelineSummaries(
