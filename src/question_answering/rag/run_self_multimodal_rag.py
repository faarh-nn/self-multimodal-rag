...
def run_pipeline_with_summaries_single(qa_model, embedding_model, vectorstore_path, input_text_df, input_img_df, reference_qa, output_dir, img_summaries_dir, user_images_dir=None):
    summaries_pipeline = SelfMultimodalRAGPipelineSummaries(
        model_type=qa_model,
    ...
    # Load data referensi pertanyaan-jawaban
    ...
    output_file = os.path.join(output_dir, f"rag_output_{qa_model}_self_multimodal_rag.json")
